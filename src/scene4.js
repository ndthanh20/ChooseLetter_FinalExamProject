...
var Scene4 = /** @class */ (function (_super) {
    ...
    Scene4.prototype.init = function ( /*params: any*/) {
    };
    Scene4.prototype.create = function () {
        //add sound
    ...
    Scene4.prototype.startClick = function (pointer, targets) {
        this.input.off('pointerdown', this.startClick, this);
        this.audio.play();
    };
    Scene4.prototype.finish = function () {
        var _this = this;
        this.time.addEvent({
            delay: 2500,
            callback: function () {
